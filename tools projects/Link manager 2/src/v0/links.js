...
function renderLinkGrid(links) {
  links.forEach(link => {
    ...
    if (link.type === 'youtube' && link.thumbnail) {
      ...
      imageContent = `<img src="${link.favicon}" class="link-favicon" alt="Favicon">`;
    } else {
      imageContent = `<i class="fa ${link.type === 'youtube' ? 'fa-youtube youtube' : 'fa-globe'} link-icon"></i>`;
    }
    ...
    card.innerHTML = `
      <div class="link-card-header">
        <div class="link-image">${imageContent}</div>
